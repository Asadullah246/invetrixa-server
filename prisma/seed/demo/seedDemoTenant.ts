  ...
  await prisma.$transaction(async (tx) => {
    ...
    const tenant = await tx.tenant.upsert({
      ...
      create: {
        ...
        businessEmail: 'demo@pxlhut.com',
        businessPhone: '+8801700000001',
        website: 'https://demo.pxlhut.com',
        description:
          'Demo tenant for testing and demonstration purposes. This tenant showcases all features of the Pxlhut platform.',
