    ...
    const demoUsers: DemoUserData[] = [
      {
        ...
        email: 'owner@demo.invetrixa.com',
      ...
      },
      {
        ...
        firstName: faker.person.firstName(),
        lastName: faker.person.lastName(),
        email: 'manager1@demo.invetrixa.com',
      ...
      },
      {
        ...
        firstName: faker.person.firstName(),
        lastName: faker.person.lastName(),
        email: 'manager2@demo.invetrixa.com',
        roleId: DEMO_ROLE_IDS.ADMIN,
        roleName: 'Admin',
      ...
      },
      {
        ...
        firstName: faker.person.firstName(),
        lastName: faker.person.lastName(),
        email: 'staff1@demo.invetrixa.com',
      ...
      },
      {
        ...
        firstName: faker.person.firstName(),
        lastName: faker.person.lastName(),
        email: 'staff2@demo.invetrixa.com',
        roleId: DEMO_ROLE_IDS.EDITOR,
        roleName: 'Editor',
        accessScope: AccessScope.TENANT, // Will be overridden in phase 2
        locationId: null,
